...
class Messages():
      HELP_MSG = [
        ".",
f"""
**Hello Friends, Saya adalah 𝐑𝐨𝐛𝐨𝐭𝐌𝐮𝐬𝐢𝐜𝐁𝐨𝐭
\n❂ 𝙈𝙖𝙨𝙪𝙠𝙠𝙖𝙣 𝘽𝙤𝙩 >> @robotxmusic_bot 
❂ 𝙈𝙖𝙨𝙪𝙠𝙠𝙖𝙣 𝘼𝙨𝙨𝙞𝙨𝙩𝙚𝙣 >> @robotassisten**
...
*) 𝑷𝒂𝒔𝒕𝒊𝒌𝒂𝒏 𝒔𝒖𝒅𝒂𝒉 𝒎𝒆𝒎𝒂𝒔𝒖𝒌𝒌𝒂𝒏 𝒂𝒔𝒔𝒊𝒔𝒕𝒆𝒏 >> @robotassisten 𝒅𝒊𝒅𝒂𝒍𝒂𝒎 𝑮𝒓𝒖𝒃. 
""", 
...
f""" 🎶 **Hello Friends**, Saya 𝐑𝐨𝐛𝐨𝐭𝐌𝐮𝐬𝐢𝐜𝐁𝐨𝐭! 👏
